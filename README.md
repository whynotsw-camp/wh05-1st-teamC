...
gantt
    ...
    콘텐츠 유사도 추천 실험         :a4, 2025-04-29, 7d

    section 🧠 추천 알고리즘 개발
    실시간 트렌드 반영 기획         :a5, 2025-04-22, 7d
    추천 알고리즘 개발 시작         :a6, 2025-04-29, 61d

    section 🔧 추천 알고리즘 개선
    유저 피드백 기반 개선 구상      :a8, 2025-06-10, 7d
    ...
    알고리즘 개선 마무리           :a19, 2025-07-15, 7d

    section 🎯 UI 개선 및 사용자 테스트
    UI 개선                      :a20, 2025-07-15, 7d
    사용자 테스트                 :a21, 2025-07-22, 7d
    최종 보완                    :a22, 2025-07-22, 7d

    section ✅ 통합 테스트 및 안정화
